...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "projetArchi@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "projetArchi API";

        private String description = "projetArchi API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "projetArchi";
